...
IMAGE_MODELS: Dict[str, Dict[str, Any]] = {
    ...
    "flux-lustly": {
        "name": "🔥 FLUX-Lustly.ai (NSFW)",
        "space": "lustlyai/Flux_Lustly.ai_Uncensored_nsfw_v1",
        "steps": 28,
        "guidance": 3.5,
        "desc": "Lustly.ai uncensored FLUX LoRA",
        "type": "flux",
        "fast": False,
        "uncensored": True,
    },
    "flux-enhance-uncensored": {
        "name": "🔥 FLUX-Enhance-V2 (NSFW)",
        "space": "enhanceaiteam/Flux-Uncensored-V2",
        "steps": 28,
        "guidance": 3.5,
        "desc": "Enhanced uncensored FLUX V2",
        "type": "flux",
        "fast": False,
        "uncensored": True,
    },
    "illustrious-uncensored": {
        "name": "🔥 Illustrious-XL Uncensored",
        "space": "John6666/illustrious-xl10-improved-uncensored-v30-sdxl",
        "steps": 30,
        "guidance": 7.0,
        "desc": "SDXL Illustrious uncensored - anime/photorealistic",
        "type": "sdxl",
        "fast": False,
        "uncensored": True,
    },
    "realistic-vision-uncensored": {
        "name": "🔥 Realistic Vision (NSFW)",
        "space": "SG161222/Realistic_Vision_V6.0_B1_noVAE",
        "steps": 25,
        "guidance": 7.0,
        "desc": "Photorealistic SD 1.5 - uncensored capable",
        "type": "sd15",
        "fast": True,
        "uncensored": True,
    },
    "wan2.1-sexual": {
        "name": "🔥🔥 WAN2.1-Sexual (Most DLs)",
        "space": "Wan-AI/Wan2.1-T2V-14B",
        "steps": 28,
        "guidance": 7.5,
        "desc": "WAN2.1 optimized for explicit sexual content - highest downloads",
        "type": "wan",
        "fast": False,
        "uncensored": True,
        "sexual": True,
    },
    "gemini-heretic-uncensored": {
        "name": "🔥🔥 Gemini-Pro-Heretic (Gemini Uncensored)",
        "space": "Andycurrent/Gemma-3-4B-VL-it-Gemini-Pro-Heretic-Uncensored-Thinking_GGUF",
        "steps": 25,
        "guidance": 7.0,
        "desc": "Gemini 4B uncensored - best for explicit fucking",
        "type": "gemini",
        "fast": True,
        "uncensored": True,
    },
    "pony-diffusion-v6": {
        "name": "🔥🔥 Pony Diffusion V6 (NSFW King)",
        "space": "AbyssOrangeMix3/ponyDiffusionV6",
        "steps": 28,
        "guidance": 7.0,
        "desc": "Pony V6 - trending sexual content, best for explicit",
        "type": "sdxl",
        "fast": False,
        "uncensored": True,
    },
